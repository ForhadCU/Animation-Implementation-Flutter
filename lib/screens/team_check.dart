...
class TeamCheckScreen extends StatefulWidget {
  const TeamCheckScreen({Key? key}) : super(key: key);
  @override
                                  ...
                                  child: Container(
                                    ...
                                    child: TextField(
                                      decoration: InputDecoration(
                                        ...
                                        isDense: true,
                                        contentPadding: EdgeInsets.only(top: 0, bottom: 0, right: 5, left: 8),
                                        suffixIcon: IconButton(
                                            onPressed: () {},
                                            icon: const Image(
                                                color: Color.fromRGBO(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        label: Text('Team ID'),
                                        isDense: true,
                                        contentPadding: EdgeInsets.only(top: 0, left: 8, bottom: 0, right: 5),
                                        suffixIcon: IconButton(
                                            onPressed: () {},
                                            icon: const Image(
                                                color: Color.fromRGBO(
