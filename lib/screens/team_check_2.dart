...
import 'package:my_flutter_animations/constants/colors.dart';

class TeamCheckScreen2 extends StatefulWidget {
  const TeamCheckScreen2({Key? key}) : super(key: key);
  @override
  _TeamCheckScreen2State createState() => _TeamCheckScreen2State();
}

class _TeamCheckScreen2State extends State<TeamCheckScreen2>
